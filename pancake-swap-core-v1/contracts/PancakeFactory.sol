...
contract PancakeFactory is IPancakeFactory {
    ...
    /// @notice Give number of pair of tokens existed in the contract
    function allPairsLength() external view returns (uint) {
    ...
    /// @notice Return incentive to an account
    /// @dev the msg.sender must be the Setter
    /// @param _feeTo address of the account can received incentive 
